...
//
// Reutilizado del Proyecto 2. El unico cambio es el orden de los
// registros, para coincidir con el mapa del Proyecto 3:
//
// Mapa de registros (interfaz estandar de 32 bits)
// ------------------------------------------------
//   addr 00  CONTROL    0x0001_0040  bit 0 send, bit 1 new_rx
//   addr 01  DATOS TX   0x0001_0044  bits [7:0] byte a transmitir
//   addr 10  DATOS RX   0x0001_0048  bits [7:0] ultimo byte recibido
//   addr 11  reservado, lee cero
//
// En el Proyecto 2 el orden era TX = 00, RX = 01, CONTROL = 10.
//
