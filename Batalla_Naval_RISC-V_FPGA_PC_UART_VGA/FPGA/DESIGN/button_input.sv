...
//
// Reutilizado del Proyecto 2 sin cambios de logica. En el Proyecto 3
// se instancia una vez por cada entrada del Jugador 1 y solo se usa el
// nivel filtrado (level_o): las pulsaciones las detecta el programa.
// =====================================================================
