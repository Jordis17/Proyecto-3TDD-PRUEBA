...
//
// De esta forma se obtiene un tick de 1 ms. Reutilizado del Proyecto 2;
// en el Proyecto 3 el reloj del sistema es de 50 MHz, por lo que el top
// lo instancia con TICK_CYCLES = 50_000. El tick es la base de tiempo
// del antirrebote, del barrido de los displays y del buzzer.
// =====================================================================
